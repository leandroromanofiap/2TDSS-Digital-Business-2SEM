...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="<c:url value="/produto/buscar"/>">
      <input name="nomeProduto" class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
